  ...
  return (
    <div className="rounded-xl border bg-card p-4">
      <div className="mb-2 flex items-center gap-2 text-xs">
        <span className="inline-flex rounded-full bg-muted px-2 py-0.5 capitalize">{item.type}</span>
        {item.answered && <span className="inline-flex rounded-full bg-emerald-100 text-emerald-700 px-2 py-0.5">Answered</span>}
        <span className="text-muted-foreground ml-auto">{day} at {time}</span>
      </div>
