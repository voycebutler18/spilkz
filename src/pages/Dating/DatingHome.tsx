...
import React, { useState, useEffect } from 'react';// src/pages/Dating/DatingHome.tsx
...
const SplikzDatingHome = () => {
  ...
  // ✅ FIX: use a proper JS array for height options (no broken JSX escaping)
  ...
  // ─────────────────────────────────────────────────────────────
  // Signup screen (unchanged except for height select)
  // ─────────────────────────────────────────────────────────────
  if (showSignup) {
    return (
